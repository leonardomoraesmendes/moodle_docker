...
/**
 * Strings for component 'admin', language 'pt_br', branch 'MOODLE_37_STABLE'
 *
 * @package   admin
...
$string['allowframembedding_help'] = 'Se ativado, este site pode ser incorporado em um frame em um sistema remoto, como recomendado se estiver utilizando plugin de inscrição \'Publicar como ferramenta LTI\'. Caso contrário, recomenda-se a deixar moldura de incorporação desativada por motivos de segurança.<br />Por favor, observe também que, para o aplicativo móvel essa configuração é ignorada e a incorporação de frames é sempre permitida.';
...
$string['configallowthemechangeonurl'] = 'Se habilitado, o tema pode ser mudado acrescentando: <br />?theme=nome-do-tema a qualquer URL no Moodle (ex: meu-moodle.com.br/?theme=boost ) ou <br/>&theme=nome-do-tema a qualquer URL interna do Moodle (ex: meu-moodle.com.br/course/view.php?id=2&theme=moove).';
